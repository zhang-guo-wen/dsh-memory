window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const tagId = "@guowenzhang/dsh-memory/MemorySection.module.css";
		...
		*/
		async function apply(ctx) {
			...
			const controller = new MemorySectionController(ctx.configForms.get(MEMORY_SETTINGS_NS), {
